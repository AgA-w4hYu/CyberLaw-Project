...
/// Reverse Engineering challenge — presents obfuscated logic puzzles
/// that the user must decode to find the flag.
class ReverseChallenge extends StatefulWidget {
  final CtfChallengeModel? challenge;
  const ReverseChallenge({super.key, this.challenge});

  @override
  State<ReverseChallenge> createState() => _ReverseChallengeState();
}

class _ReverseChallengeState extends State<ReverseChallenge> {
  ...
  late final CtfChallengeModel _challenge =
      widget.challenge ?? CtfData.challenges.firstWhere((c) => c.id == 'reverse-01');
        ...
        actions: [
          Container(
            ...
            child: const Row(
              ...
              children: [
                Icon(Icons.memory, color: AppTheme.accent, size: 14),
                SizedBox(width: 4),
                Text('REVERSE', style: TextStyle(color: AppTheme.accent, fontSize: 10, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        ],
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFF1A0510), AppTheme.surface],
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          _challenge.title,
                          style: GoogleFonts.orbitron(color: AppTheme.accent, fontSize: 15, fontWeight: FontWeight.bold),
                        ),
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      const Icon(Icons.memory, color: AppTheme.accent, size: 14),
                      const SizedBox(width: 4),
                      Text(
                        'REVERSE ENGINEERING',
                        style: const TextStyle(color: AppTheme.accent, fontSize: 12, letterSpacing: 1),
                      ),
                    ],
                  ),
                ],
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Reverse engineering = mengurai kode/teks yang sudah di-obfuscate untuk memahami logika aslinya.',
            ...
            _buildObfuscatedBlock(_challenge.description),
            const SizedBox(height: 20),
  ...
  Widget _buildObfuscatedBlock(String text) {
    return Container(
      width: double.infinity,
