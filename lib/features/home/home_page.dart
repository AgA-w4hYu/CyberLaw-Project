                ...
                GridView.count(
                  ...
                  children: [
                    _FeatureCard(
                      ...
                      onTap: () => context.push(AppConstants.routeCyberLaw),
                      index: 0,
                    ),
                    _FeatureCard(
                      ...
                      onTap: () => context.push(AppConstants.routeTools),
                      index: 1,
                    ),
                    _FeatureCard(
                      icon: Icons.science,
                      ...
                      onTap: () => context.push(AppConstants.routeCyberLab),
                      index: 2,
                    ),
                    _FeatureCard(
                      icon: Icons.report_problem,
                      label: 'Laporkan',
                      subtitle: 'Kejahatan Siber',
                      color: AppTheme.accent,
                      onTap: () => context.push(AppConstants.routeReport),
                      index: 3,
                    ),
                    _FeatureCard(
                      icon: Icons.people,
                      label: 'Komunitas',
                      subtitle: 'White-Hat Hub',
                      color: AppTheme.warning,
                      onTap: () => context.push(AppConstants.routeCommunity),
                      index: 4,
                    ),
                    _FeatureCard(
                      icon: Icons.leaderboard,
                      label: 'Leaderboard',
                      subtitle: 'Top Hackers',
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _pressed ? AppTheme.neonGlow(widget.color, spread: 2) : null,
        ),
...
class _InsightPreviewSection extends StatelessWidget {
  final List<SecurityInsightModel> _previewInsights =
      SecurityInsightData.insights.take(3).toList();
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        const Text(
          'Buat user yang panik karena akun diretas, HP hilang, atau kena phishing.',
          style: TextStyle(
            color: AppTheme.textSecondary,
            fontSize: 12,
            height: 1.45,
