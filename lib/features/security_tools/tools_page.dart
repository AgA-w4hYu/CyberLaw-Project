  ...
  Widget build(BuildContext context) {
    final tools = [
      ...
      _ToolEntry(
        ...
        label: 'Data Leak Scanner',
        desc: 'Simulasi cek email bocor di dark web',
...
class _ToolEntry {
  ...
  final Color color;
  final String route;
  const _ToolEntry({required this.icon, required this.label, required this.desc, required this.color, required this.route});
}
